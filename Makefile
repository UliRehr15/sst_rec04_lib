...
# Template: lib
# Command: /usr/lib/qt5/bin/qmake -o Makefile sstRec04Lib.pro -spec linux-g++ CONFIG+=debug
#############################################################################
...
INCPATH       = -I. -IHeader -I../sstMath01Lib/Header -I../sst_str01_lib/Header -I../sst_misc01_lib/Header -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++
...
../libs/libsst_rec04_lib_d.a:  $(OBJECTS) $(OBJCOMP) 
	@test -d ../libs/ || mkdir -p ../libs/
	-$(DEL_FILE) ../libs/$(TARGET)
	$(AR) $(DESTDIR)$(TARGET) $(OBJECTS)


Makefile: sstRec04Lib.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		sstRec04Lib.pro
	$(QMAKE) -o Makefile sstRec04Lib.pro -spec linux-g++ CONFIG+=debug
...
all: Makefile ../libs/libsst_rec04_lib_d.a
...
sstRec04LifoStore.o: sstRec04LifoStore.cpp ../sst_str01_lib/Header/sstStr01Lib.h \
		../sstMath01Lib/Header/sstMath01Lib.h \
		Header/sstRec04Lib.h \
		../sst_misc01_lib/Header/sstMisc01Lib.h \
		sstRec04LibInt.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sstRec04LifoStore.o sstRec04LifoStore.cpp

sstRec04QSortStr.o: sstRec04QSortStr.cpp ../sst_str01_lib/Header/sstStr01Lib.h \
		../sstMath01Lib/Header/sstMath01Lib.h \
		../sst_misc01_lib/Header/sstMisc01Lib.h \
		Header/sstRec04Lib.h \
		sstRec04LibInt.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sstRec04QSortStr.o sstRec04QSortStr.cpp
...
sstRec04quicksort.o: sstRec04quicksort.cpp ../sst_str01_lib/Header/sstStr01Lib.h \
		../sstMath01Lib/Header/sstMath01Lib.h \
		Header/sstRec04Lib.h \
		../sst_misc01_lib/Header/sstMisc01Lib.h \
		sstRec04LibInt.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sstRec04quicksort.o sstRec04quicksort.cpp
